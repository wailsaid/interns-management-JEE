...
<div class="app-main">
 ...
 <div Style='margin-bottom: 5vh;'>
  ...
  <c:if test="${sessionScope.user.username ne 'employe'}"> <button class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/ajouterstagire'">Ajouter</button></c:if>
   </c:if>
</div>
